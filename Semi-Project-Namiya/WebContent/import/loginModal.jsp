...
<script type="text/javascript">
   $(document).ready(function() {
      $(".cd-signin-modal__form").submit(function() {
         $.ajax({
            type:"post",
            dataType:"json",
            url:"${pageContext.request.contextPath}/dispatcher",
            data:$(".cd-signin-modal__form").serialize(),
...
<div class="cd-signin-modal js-signin-modal"> <!-- this is the entire modal form, including the background -->
		<div class="cd-signin-modal__container"> <!-- this is the container wrapper -->
			...
			<div class="cd-signin-modal__block js-signin-modal-block" data-type="login">
				<!-- 로그인폼 -->
				<form class="cd-signin-modal__form" action="${pageContext.request.contextPath}/dispatcher" method="post">
